...
Original file is located at
    https://colab.research.google.com/drive/13Qk1NghM8ufPcqXegFvdPvUXF7hXoH2x
...
filename = 'Car_Price_Model_Linear_Regression.sav'
pickle.dump(linear_regression_model, open(filename, 'wb'))

filename = 'Car_Price_Model_Lasso_Regression.sav'
